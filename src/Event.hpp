...
static Map<int, std::string> EventTypeString = {Pair<int, std::string>(INITIALIZED, "INITIALIZED"), Pair<int, std::string>(TERMINATED, "TERMINATED"),
    Pair<int, std::string>(WORKER_SCAN_STARTED, "WORKER_SCAN_STARTED"), Pair<int, std::string>(WORKER_SCAN_FINISHED, "WORKER_SCAN_FINISHED"),
    Pair<int, std::string>(WORKER_SCAN_ERRORED, "WORKER_SCAN_ERRORED"), Pair<int, std::string>(WORKER_SCAN_ITEM_STARTED, "WORKER_SCAN_ITEM_STARTED"),
    Pair<int, std::string>(WORKER_SCAN_ITEM_FINISHED, "WORKER_SCAN_ITEM_FINISHED"), Pair<int, std::string>(WORKER_ENCODE_STARTED, "WORKER_ENCODE_STARTED"),
    Pair<int, std::string>(WORKER_ENCODE_FINISHED, "WORKER_ENCODE_FINISHED"), Pair<int, std::string>(WORKER_ENCODE_ERRORED, "WORKER_ENCODE_ERRORED"),
    Pair<int, std::string>(WORKER_ENCODE_ITEM_STARTED, "WORKER_ENCODE_ITEM_STARTED"), Pair<int, std::string>(WORKER_ENCODE_ITEM_FINISHED, "WORKER_ENCODE_ITEM_FINISHED"),
    Pair<int, std::string>(PROGRESS_PRIMARY_UPDATED, "PROGRESS_PRIMARY_UPDATED"), Pair<int, std::string>(PROGRESS_PRIMARY_MAXIMUM, "PROGRESS_PRIMARY_MAXIMUM"),
    Pair<int, std::string>(PROGRESS_SECONDARY_UPDATED, "PROGRESS_SECONDARY_UPDATED"), Pair<int, std::string>(PROGRESS_SECONDARY_MAXIMUM, "PROGRESS_SECONDARY_MAXIMUM"),
    Pair<int, std::string>(CONFIG_SAVED, "CONFIG_SAVED"), Pair<int, std::string>(CONFIG_LOADED, "CONFIG_LOADED"), Pair<int, std::string>(PRESET_SAVED, "PRESET_SAVED"),
    Pair<int, std::string>(PRESET_LOADED, "PRESET_LOADED"), Pair<int, std::string>(CUSTOM, "CUSTOM"), Pair<int, std::string>(ERROR, "ERROR")};
