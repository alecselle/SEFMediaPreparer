...
class Settings {
    ...
    const boost::container::vector<boost::container::vector<std::string>> DEFAULT_VCODECS {{{"libx265", "hevc", "x265", "h265"}, {"hevc_amf", "libx265", "hevc", "x265", "h265"},
        {"hevc_nvenc", "libx265", "hevc", "x265", "h265"}, {"hevc_qsv", "libx265", "hevc", "x265", "h265"}, {"libx264", "x264", "h264"}, {"h264_amf", "libx264", "x264", "h264"},
        {"h264_nvenc", "libx264", "x264", "h264"}, {"h264_qsv", "libx264", "x264", "h264"}, {"libvpx", "libvpx-vp9", "vp9", "vpx"}, {"copy"}}};
    // Default audio codecs
    const boost::container::vector<boost::container::vector<std::string>> DEFAULT_ACODECS {{{"aac"}, {"ac3"}, {"libopus", "opus"}, {"libmp3lame", "mp3", "libmp3"}, {"copy"}}};
    // Default containers
    ...
    const boost::container::vector<std::string> SUBTITLE_CONTAINERS {{"mkv", "mp4", "mov"}};
